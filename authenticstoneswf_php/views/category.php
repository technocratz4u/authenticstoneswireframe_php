                ...
                <div class="col-md-9">
                    ...
                    <div class="row products">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                             <a href="#">
                                    <img src="<?php echo __WEB_ROOT?>/static/img/ruby-3d.jpg" alt="" class="img-responsive">
                                </a>
                                <div class="text">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                <a href="#">
                                    <img src="<?php echo __WEB_ROOT?>/static/img/emrald-3d.jpg" alt="" class="img-responsive">
                                </a>
                                <div class="text">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                <a href="#">
                                    <img src="<?php echo __WEB_ROOT?>/static/img/sapphire-3d.jpg" alt="" class="img-responsive">
                                </a>
                                <div class="text">
