<header id="header">
    ...
    <h1 class="brand">Authentic Stones Co., Ltd.</h1>
	          ...
	          <div class="navbar-header">
	            ...
	            <button type="button" onclick="location.href = '<?php echo __WEB_ROOT?>/basket';" class="navbar-toggle btn btn-dark" id="home-navbar-cart-button-collapsed" data-toggle="collapse" data-target="#links"><i class="fa fa-shopping-cart"></i><span class="hidden-sm"> cart</span> <span class="badge">4</span></button>
	          ...
	          <div id="navbar-collapse-grid" class="navbar-collapse collapse">
                                ...
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <h5>Stones</h5>
                                            <ul>
                                                <li><a href="<?php echo __WEB_ROOT?>/category">Ruby</a>
                                                </li>
                                                <li><a href="<?php echo __WEB_ROOT?>/category">Sapphire</a>
                                                </li>
                                                <li><a href="<?php echo __WEB_ROOT?>/category">Emerald</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-sm-4">
                                            ...
                                            <ul>
                                                <li><a href="<?php echo __WEB_ROOT?>/category">Tsavorite</a>
                                                </li>
                                                <li><a href="<?php echo __WEB_ROOT?>/category">Aquamarine</a>
                                                </li>
                                                <li><a href="<?php echo __WEB_ROOT?>/category">Tourmaline</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-sm-4">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="<?php echo __WEB_ROOT?>/category">Rose Quartz</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
	            ...
	            <ul class="nav navbar-nav navbar-right hidden-xs">
			        <li><button type="button" class="btn btn-dark" onclick="location.href = '<?php echo __WEB_ROOT?>/basket';" id="home-navbar-cart-button"><i class="fa fa-shopping-cart"></i><span class="hidden-sm"> cart</span> <span class="badge">4</span></button></li>
			     </ul>
	          </div>
	        </div>
</header>